...
<li><a href="#"><img id="menuBurguer" alt="Logotipo Inovamed" src="assets/img/icon/iconeMenuBurgerranco.png"></a> 
<ul class="submenu-1">
...
      
<li><a href="#"><img id="iconChamados" alt="Logotipo Chamados" src="assets/img/icon/iconChamados.png">Chamados</a>            
<ul class="submenu-2">
